    ...
    <main>
      ...
      <div className="page-shell">
        <header className="hero">
          ...
          <h1><Sparkle>✦</Sparkle> Casey &amp; Jordan <Sparkle>✦</Sparkle></h1>
          ...
          <p className="date-stamp">SATURDAY • SEPTEMBER 12, 2026 • 4:00 PM</p>
        </header>
        ...
        <section id="details" className="details-grid">
          <article className="retro-window detail-card"><div className="title-bar pink"><span>📅</span> WHEN</div><div className="window-body"><p className="pixel-label">SAVE THE DATE</p><h2>SEPT. 12, 2026</h2><p>Ceremony at 4:00 PM</p><p>Dinner &amp; dancing to follow!</p></div></article>
          <article className="retro-window detail-card"><div className="title-bar teal"><span>📍</span> WHERE</div><div className="window-body"><p className="pixel-label">THE WILDFLOWER LODGE</p><h2>BOULDER, CO</h2><p>Mountain views + garden vibes</p><p>Dress code: Festive garden party</p></div></article>
        </section>
        ...
        <footer><p>You are visitor number:</p><div className="counter" aria-label="Visitor number 0001999">0 0 0 1 9 9 9</div><p className="updated">Last updated: 08/10/2026 at 11:59 PM</p><p className="tiny">Made with ♥, HTML, and a dream • © 2026 Casey &amp; Jordan<br />This page hosted by GeoHearts™</p></footer>
      </div>
    </main>
  );
}
